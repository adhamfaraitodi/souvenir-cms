...
class ThemeSeeder extends Seeder
{
    ...
    {
        $theme=[
            [ "title"=>'Default',"html_code" => '<div class="container">
        <div class="hero">
            <img id="logo" src="" alt="Company Logo">
            <h1 id="company_name"></h1>
            <img id="hero_image" src="" alt="Hero Image">
        </div>
        <h2 id="headtitle"></h2>
        <p id="subtitle"></p>
        ...
        <div class="gallery">
            <img id="gallery_1" src="" alt="Gallery Image 1">
            <img id="gallery_2" src="" alt="Gallery Image 2">
            <img id="gallery_3" src="" alt="Gallery Image 3">
        </div>
    </div>', "css_code" => '        body {
